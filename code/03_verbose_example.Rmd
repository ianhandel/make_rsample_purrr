...
>As the number of cylinders in an engine increase and the engine displacement increases, the highway miles per gallon reduces (F ^4,229^ = 90.25, p < 0.001). On a cross-validated sample the mean RMSE of the model was 3.71mpg (min = 2.98mpg, max = 5.16mpg)


_Note: the actual figures of the rmse may differ because its resampled each time this is compiled_
